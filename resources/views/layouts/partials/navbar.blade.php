            ...
            <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-xl-2 me-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end p-0">
                    ...
                    <li class="dropdown-notifications-list scrollable-container ps ps--active-y">
                            ...
                            <li class="list-group-item list-group-item-action dropdown-notifications-item waves-effect">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <small class="d-block text-body mb-1">Won the monthly best seller gold
                                            badge</small>
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <small class="d-block text-body mb-1">Your ABC project application has been
                                            approved.</small>
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <small class="d-block text-body mb-1">July monthly financial report is
                                            generated </small>
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <small class="d-block text-body mb-1">CPU Utilization Percent is currently at
                                            88.63%,</small>
                                        <small class="text-muted">5 days ago</small>
                                    </div>
                                    <div class="dropdown-notifications-actions flex-shrink-0">
                        ...
                        <div class="ps__rail-y" style="top: 0px; right: 0px; height: 385px;">
                                            ...
                                            @auth
                                                @if (auth()->user()->userData && auth()->user()->userData->image)
                                                    <img src="{{ asset('storage/profile_images/' . basename(auth()->user()->userData->image)) }}"
                                                        alt="Profile" class="rounded-circle" />
                                                @else
                                                    <img src="{{ asset('demo2/assets/img/avatars/1.png') }}"
