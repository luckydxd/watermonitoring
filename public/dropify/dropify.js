...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        messages: {
            default: "Tarik dan lepas file di sini atau klik",
            replace: "Tarik dan lepas atau klik untuk mengganti",
            remove: "Hapus",
        ...
        error: {
            ...
            minWidth:
                "Lebar gambar terlalu kecil (minimal {{ value }} piksel).",
            maxWidth:
                "Lebar gambar terlalu besar (maksimal {{ value }} piksel).",
            minHeight:
                "Tinggi gambar terlalu kecil (minimal {{ value }} piksel).",
            maxHeight:
                "Tinggi gambar terlalu besar (maksimal {{ value }} piksel).",
            imageFormat: "Format gambar tidak diizinkan (hanya {{ value }}).",
            fileExtension: "Jenis berkas tidak diizinkan (hanya {{ value }}).",
        },
        tpl: {
            wrap: '<div class="dropify-wrapper"></div>',
            loader: '<div class="dropify-loader"></div>',
            message:
                '<div class="dropify-message"><span class="file-icon" /> <p style="font-size: 15px; font-family: \'Public Sans\', sans-serif; font-weight: 400; color: #333;">{{ default }}</p></div>',
            preview:
